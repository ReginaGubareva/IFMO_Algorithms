...
public class Main {
    public static void main(String[] args){
        ...
        try(BufferedReader input = new BufferedReader(new FileReader("input.txt"));
            BufferedWriter output = new BufferedWriter(new FileWriter("output.txt.txt"))){
...
//            output.txt.write(arrayAsString(antiQuickSort.generateKiller(n)));

            //MergeSortRecursive mergeSortRecursive = new MergeSortRecursive();
            //mergeSortRecursive.sort(array, 0, array.length-1, output.txt.txt);

            //MergeSortIterative mergeSortIterative = new MergeSortIterative();
            // mergeSortIterative.sort(array, output.txt.txt);
