...
class SwapSecretary{
	public static void main(String[] args){
		try(FileReader reader = new FileReader("D:\\alghorithms\\IFMOcourse\\Algorithms\\templates\\input.txt");
			FileWriter writer = new FileWriter("D:\\alghorithms\\IFMOcourse\\Algorithms\\templates\\output.txt")){
